                ...
                <div class="flex items-center">
                    ...
                    <div class="hidden md:block">
                        <div class="ml-10 flex items-baseline space-x-4">
                            ...
                            <a href="#" class="text-gray-900 bg-gray-100 px-3 py-2 rounded-md text-sm font-medium">Task Details</a>
                            ...
                            <div class="flex-1">
                                <div class="bg-gray-50 rounded-lg p-4">
                                    ...
                                    <p class="mt-1 text-sm text-gray-600">
                                        I've started working on the API documentation. Will update you once it's ready for review.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                            <div class="flex items-center space-x-3">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-900">UI_Mockup.png</p>
                ...
                <div class="bg-white rounded-lg shadow-lg p-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                <p class="text-sm text-gray-600">Task created by John Doe</p>
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                <p class="text-sm text-gray-600">Status changed to In Progress</p>
                                <p class="text-xs text-gray-400">1 day ago</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <div class="w-2 h-2 mt-2 bg-yellow-600 rounded-full"></div>
                            <div class="ml-4">
                                <p class="text-sm text-gray-600">Priority updated to Medium</p>
                                <p class="text-xs text-gray-400">12 hours ago</p>
                            </div>
                        </div>
                    </div>
                </div>
